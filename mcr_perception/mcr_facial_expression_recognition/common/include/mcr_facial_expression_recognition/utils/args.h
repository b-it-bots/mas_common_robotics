...
namespace nor_utils
{
	...
	class Args
	{
 	public:
		 ...
		 * @date 28/11/2005
		 */
		void declareArgument(const string& name, const string& description, int numValues = 0, const string& valuesNamesList = "");
 	...
 	private:
		 ...
		 * @date 28/11/2005
		 */
		string getWrappedString(const string& str, int leftSpace = 0, bool spacesInFirstLine = true) const;
		...
		struct Argument
		{
			 ...
			 * @date 28/11/2005
			 */
			Argument(const string& name, const string& description = "", int numValues = 0, const string& valuesNamesList = "")
					: name(name),
					  description(description),
					  numValues(numValues),
					  valuesNamesList(valuesNamesList)
			{
			}
