...
class ObjectSegmentation
{
 public:
	...
	bool GetObjectList(mcr_perception_msgs::GetObjectList::Request &req, mcr_perception_msgs::GetObjectList::Response &res);
 ...
 private:
	...
	IplImage _ipl_img;
	mcr_perception_msgs::GetObjectList::Response _last_segmented_objects;
