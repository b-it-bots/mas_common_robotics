...
# this script performs a search with many different mercury_planner parameters
# It can be used to test which is the best set of parameters for a particular planning problem
...
--search "lazy_wastar([hrb,hlm1],preferred=[hrb,hlm1],w=1)" \
--plan-file mercury_param1_w1.plan < output

echo 'parameters 1 w=2'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm1=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=1,cost_type=1))" \
--search "lazy_wastar([hrb,hlm1],preferred=[hrb,hlm1],w=2)" \
--plan-file mercury_param1_w2.plan < output

echo 'parameters 1 w=3'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm1=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=1,cost_type=1))" \
--search "lazy_wastar([hrb,hlm1],preferred=[hrb,hlm1],w=3)" \
--plan-file mercury_param1_w3.plan < output

echo 'parameters 1 w=4'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm1=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=1,cost_type=1))" \
--search "lazy_wastar([hrb,hlm1],preferred=[hrb,hlm1],w=4)" \
--plan-file mercury_param1_w4.plan < output

echo 'parameters 1 w=5'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm1=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=1,cost_type=1))" \
--search "lazy_wastar([hrb,hlm1],preferred=[hrb,hlm1],w=5)" \
--plan-file mercury_param1_w5.plan < output

#parameters 2 (hml2)
echo 'parameters 2 w=1'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm2=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=2,cost_type=2))" \
--search "lazy_wastar([hrb,hlm2],preferred=[hrb,hlm2],w=1)" \
--plan-file mercury_param2_w1.plan < output

echo 'parameters 2 w=2'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm2=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=2,cost_type=2))" \
--search "lazy_wastar([hrb,hlm2],preferred=[hrb,hlm2],w=2)" \
--plan-file mercury_param2_w2.plan < output

echo 'parameters 2 w=3 DEFAULT'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm2=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=2,cost_type=2))" \
--search "lazy_wastar([hrb,hlm2],preferred=[hrb,hlm2],w=3)" \
--plan-file mercury_param2_w3.plan < output

echo 'parameters 2 w=4'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm2=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=2,cost_type=2))" \
--search "lazy_wastar([hrb,hlm2],preferred=[hrb,hlm2],w=4)" \
--plan-file mercury_param2_w4.plan < output

echo 'parameters 2 w=5'
$TIME --append "$SEARCH_PATH" \
--heuristic "hrb=RB(cost_type=1, extract_plan=true, next_red_action_test=true, applicable_paths_first=true, use_connected=true)" \
--heuristic "hlm2=lmcount(lm_rhw(reasonable_orders=true,lm_cost_type=2,cost_type=2))" \
--search "lazy_wastar([hrb,hlm2],preferred=[hrb,hlm2],w=5)" \
--plan-file mercury_param2_w5.plan < output
