...
public class ClassFileManager extends ForwardingJavaFileManager {
	 ...
	 * class
	 */
	private HashMap<String, JavaClassObject> javaClassObjects = new HashMap<String, JavaClassObject>();
	...
	public ClassLoader getClassLoader(Location location) {
		return new SecureClassLoader() {
			...
			protected Class<?> findClass(String name)
				...
				byte[] b = javaClassObjects.get(name).getBytes();
	...
	public JavaFileObject getJavaFileForOutput(Location location,
		...
		javaClassObjects.put(className, new JavaClassObject(className, kind));
		return javaClassObjects.get(className);
	}
}